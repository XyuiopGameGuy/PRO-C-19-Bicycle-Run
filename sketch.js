...
mainCyclist.addAnimation("Sahilhurt",mainRacerImg2);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("Pressione a Seta Para Cima para Reiniciar o jogo!", 425, 200);
  
  
    path.velocityX = 0;
    mainCyclist.velocityY = 0;
    mainCyclist.changeAnimation("Sahilhurt",mainRacerImg2);
